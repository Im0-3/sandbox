...
module.exports = {
    ...
    path: {
        ...
        wordpress: [
            {
                from: 'public/%type%/lib/**/*',
                to: 'wordpress/wp-content/themes/eriii/lib'
            },
            {
                from: 'public/%type%/css/**/*',
                to: 'wordpress/wp-content/themes/eriii/css'
            },
            {
                from: 'public/%type%/js/**/*',
                to: 'wordpress/wp-content/themes/eriii/js'
            },
            {
                from: 'public/%type%/images/**/*',
                to: 'wordpress/wp-content/themes/eriii/images'
            }
        ]
    }
};
