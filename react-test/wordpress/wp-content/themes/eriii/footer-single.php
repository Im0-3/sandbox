<footer class="l-footer l-footer-single">
    <div class="l-footer-pagetop">
        <div class="pagetop pagetop-single">
            <a href="#" class="js-scrolltop">
                    トップへ戻る
                <span class="pagetop-icon">
                    <svg class="svg svg-drop" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" width="37.969" height="58.875" viewBox="0 0 75.937 117.75">
                        <g>
        ...
        <div class="l-footer-wave">
            <svg class="svg svg-wave" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
        ...
        <div class="l-footer-bottom">
            <div class="copyright">Copyright© 働きたくない日記 , 2016 All Rights Reserved.</div>
        </div>
</footer>
<script src="<?php echo get_template_directory_uri(); ?>/js/vender.js"></script>
